...
Approach:
- Analyzed 3.5 years of air quality data (2019–2023).
- Conducted exploratory data analysis to identify seasonal and yearly pollutant trends.
- Applied correlation analysis to study relationships between pollutants (PM2.5, NO₂, SO₂) and environmental factors (temperature, humidity).
- Built regression models to quantify and predict PM2.5 levels based on influencing variables.
- Visualized findings with clear plots and statistical summaries for interpretability.
  
Outcomes:
- Identified seasonal spikes in PM2.5, particularly during winter months.
- Found significant correlations between PM2.5 and other pollutants, as well as meteorological factors.
